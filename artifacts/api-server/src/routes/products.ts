  ...
  try {
    const [product] = await db
      ...
      .values({
        ...
        pricingMode: (data as any).pricingMode ?? undefined,
        retailDiscountPct: (data as any).retailDiscountPct != null ? String((data as any).retailDiscountPct) : undefined,
        retailNonGstDiscountPct: (data as any).retailNonGstDiscountPct != null ? String((data as any).retailNonGstDiscountPct) : undefined,
        wholesaleDiscountPct: (data as any).wholesaleDiscountPct != null ? String((data as any).wholesaleDiscountPct) : undefined,
        wholesaleNonGstDiscountPct: (data as any).wholesaleNonGstDiscountPct != null ? String((data as any).wholesaleNonGstDiscountPct) : undefined,
...
function formatProduct(p: any) {
  return {
    ...
    pricingMode: p.pricingMode ?? "direct",
    retailDiscountPct: p.retailDiscountPct != null ? Number(p.retailDiscountPct) : null,
    retailNonGstDiscountPct: p.retailNonGstDiscountPct != null ? Number(p.retailNonGstDiscountPct) : null,
    wholesaleDiscountPct: p.wholesaleDiscountPct != null ? Number(p.wholesaleDiscountPct) : null,
    wholesaleNonGstDiscountPct: p.wholesaleNonGstDiscountPct != null ? Number(p.wholesaleNonGstDiscountPct) : null,
